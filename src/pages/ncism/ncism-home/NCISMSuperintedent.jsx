...
import superintendent from "/hero/superitendent.jpg";

const NCISMSuperintedent = () => {
  return (
    <>
      <style>{`
      ...
      <div className="inner-drop-container">
        <div className="inner-drop-wrapper">
          <h2 className="inner-drop-heading">
...
export default NCISMSuperintedent;
